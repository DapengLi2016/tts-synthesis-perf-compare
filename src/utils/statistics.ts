...
export function downloadCsv(results: TestResult[], filename: string): void {
  const headers = ['ssmlIndex', 'iteration', 'isTargetEndpoint', 'provenanceEnabled', 'firstByteLatencyMs', 'lastByteLatencyMs', 'totalBytes', 'chunkCount', 'maxRtf', 'success', 'error', 'timestamp', 'requestId']
